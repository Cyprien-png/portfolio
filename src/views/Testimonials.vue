        ...
        <RotateOnScroll>
            ...
            <template #highlight="{ registerHighLight, registerFollowingWindow, registerFollow }">
                <div :ref="registerFollow" class="h-dvh w-full absolute z-20 top-0 left-0 border-white border-[3dvw] pointer-events-none">
                    <div :ref="registerFollowingWindow"
                        class="h-full w-full overflow-hidden rounded-4xl flex flex-col justify-center items-center p-[3dvw]">
                        <div :ref="registerHighLight" class="rounded-full transition-all duration-500 outline-[50dvw]">
                        </div>
                    </div>
                </div>
            </template>
            ...
            <template #content="{ registerContainer }">
                <div class="h-full w-full bg-cover rounded-4xl text-center flex items-start relative">
                    <div :ref="registerContainer" class="flex flex-col items-center gap-[6dvh] w-fit perspective-distant text-black"
                        style="height:auto;">
