    ...
    <FramedMainSection id="testimonials" class="min-h-[100dvh] flex relative bg-sky-50">
        <RotateOnScroll>
            ...
            <template #highlight="{ registerHighLight, registerFollowingWindow, registerFollow }">
                <div :ref="registerFollow" class="h-dvh w-full absolute z-20 top-0 left-0 border-white border-[3dvw] pointer-events-none">
                    <!-- <div class="h-full w-full absolute top-0 left-0 bg-[#f00a] rounded-4xl -z-20"></div> -->
                    <div :ref="registerFollowingWindow"
                        ...
                        <div :ref="registerHighLight" class="rounded-full z-20 transition-all duration-500 outline-[50dvw] outline-sky-500 relative">
            ...
            <template #content="{ registerContainer }">
                <div class="h-full w-full bg-cover rounded-4xl text-center flex items-start relative">
                    <div :ref="registerContainer" class="flex flex-col items-center gap-[6dvh] w-fit z-10 perspective-distant text-black"
                        style="height:auto;">
